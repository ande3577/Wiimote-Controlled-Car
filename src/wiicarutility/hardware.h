...
#define MAX_FORWARD_MOTOR_LEVEL 100
#define MAX_REVERSE_MOTOR_LEVEL MAX_FORWARD_MOTOR_LEVEL

#define MAX_FORWARD_MOTOR_PWM 4095
#define MAX_REVERSE_MOTOR_PWM 4095
